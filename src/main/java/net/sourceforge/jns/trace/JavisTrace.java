...
public class JavisTrace extends Trace {
     ...
     * written in compressed form (Javis is capable of reading compressed input,
     * NAM isn't, so beware). Compressed output is recommended because
     * trace-files do get big.
     */

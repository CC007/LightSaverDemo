package net.sourceforge.jns.trace;
...
public class JavisPacketHandler extends JavisHandler {
     ...
     * parameters that can occur in this event is added. The key is the name of
     * the parameter and the value an integer that is later used in a switch
     * statement thus enabling an appropriate response to each parameter.
     */

...
import net.sourceforge.jns.element.Element;
import net.sourceforge.jns.trace.Trace;
import net.sourceforge.jns.util.Preferences;
import net.sourceforge.jns.util.PriorityQueue;
...
public class Simulator implements Runnable {
     ...
     *
     * --Changed to synchronize on the command queue, and notifying sleeping
     * threads.
     */
     ...
     * This function now allows for scheduling of events to take place after the

 ...
 */
package net.sourceforge.jns.agent;
...
public class SimpleGoBackNAgent implements CO_Agent {
     ...
     * jns.agent.SimpleGoBackN.createNewAgent. This function will also take care
     * of attaching everything correctly.
     */
     ...
     * @see net.sourceforge.jns.agent.Agent
     */
    ...
    /**
     * Set up a connection with a remote host. All the details can be found in
     * the CO_Agent class. Calling this function initiates a three-way
     * handshake. Note that it takes some time to do the handshake.
     *
     * @see net.sourceforge.jns.agent.CO_Agent
     */
     ...
     * connection-teardown to be initialised. Note that it will take some time
    ...
    /**
     * Internal function to which calls are scheduled with the simulator. On
     * each call, update will try to send a packet (if the window size and ACKs
     * permit it)
     */

...
import net.sourceforge.jns.trace.Event;
import net.sourceforge.jns.util.EventGenerator;
import net.sourceforge.jns.util.Status;
...
public class SimplexLink extends Link {
    ...
    public SimplexLink(int bandwidth, double delay) {
        ...
        m_error = 0.0;
        m_cansend = true;
        m_packets = new net.sourceforge.jns.util.Queue();
        m_arrived = new net.sourceforge.jns.util.Queue();
        m_status = Status.UP;
    }
